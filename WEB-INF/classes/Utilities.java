...
public class Utilities extends HttpServlet{
	...
	public void storePayment(int orderId,
		...
		{	
			...
			{
				MySqlDataStoreUtilities.insertOrder(orderId,customer,orderName,orderPrice,userAddress,creditCardNo,orderDate,deliveryDate,maxOrderCancellationDate);
			}
         else
     ...
     public String storeReview(String userage,String productname,String producttype,String productmaker,String usergender,String useroccupation,String manrebate,String productonsale,String reviewrating,String reviewdate,String  reviewtext,String reatilerpin,String price,String city,String retailerstate){
	String message=MongoDBDataStoreUtilities.insertReview(userage,productname,username(),producttype,productmaker,usergender,useroccupation,manrebate,productonsale,reviewrating,reviewdate,reviewtext,reatilerpin,price,city,retailerstate);
		...
		Review review = new Review(userage,productname,username(),producttype,productmaker,usergender,useroccupation,manrebate,productonsale,reviewrating,reviewdate,reviewtext,reatilerpin,price,city,retailerstate);
