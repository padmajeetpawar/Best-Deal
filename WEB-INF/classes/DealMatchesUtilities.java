...
public class DealMatchesUtilities extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		pw.print("<img src='images/site/consoles.jpg'style='width: 600px; display: block; margin-left: auto; margin-right: auto' />");
		pw.print("<br> <br>");
		pw.print("<h1></h2>");
			...
			BufferedReader reader = new BufferedReader(new FileReader (new File("/Users/jeet/Desktop/tomcat/webapps/Assignment5/DealMatches.txt")));
