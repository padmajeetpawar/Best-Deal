				...
				*/
				...
				for(String prod : productsList){
					...
					if (k==0 )
					{
						...
						sb.append("<div class='item active'><div class='col-md-6' style = 'background-color: #cfd1d3;border :1px solid #cfd1d3'>");
					}
					else
					{
						sb.append("<div class='item'><div class='col-md-6' style = 'background-color: #cfd1d3 ;border :1px solid #cfd1d3' >");
					}
