      ...
      // on filling the form and clicking submit button user will be directed to submit review page
		...
		pw.print("<input type='hidden' name='productmaker' value='"+productmaker+"'>");
                ...
                pw.print("<table><tr></tr><tr></tr><tr><td> Review Rating: </td>");
                    ...
                    pw.print("<tr>");
					pw.print("<td> User Occuption : </td>");
					pw.print("<td> <input type='text' name='useroccupation'> </td>");
			        pw.print("</tr>");
                
                    pw.print("<tr>");
					pw.print("<td> Product On Sale (Yes/No) : </td>");
					pw.print("<td> <input type='text' name='productonsale'> </td>");
			        pw.print("</tr>");
                 
                    pw.print("<tr>");
					pw.print("<td> Manufacturer Rebate (Yes/No) : </td>");
					pw.print("<td> <input type='text' name='manrebate'> </td>");
			        pw.print("</tr>");
