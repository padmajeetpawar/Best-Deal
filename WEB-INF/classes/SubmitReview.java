	...
	protected void storeReview(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(!utility.isLoggedin()){
			...
			return;
                ...
                String manrebate=request.getParameter("manrebate");
                String productonsale=request.getParameter("productonsale");
                String reviewtext=request.getParameter("reviewtext");
				String retailerpin=request.getParameter("zipcode");
				String retailercity = request.getParameter("retailercity");
				String retailerstate = request.getParameter("retailerstate");
		String message=utility.storeReview(userage,productname,producttype,productmaker,usergender,useroccupation,manrebate,productonsale,reviewrating,reviewdate,reviewtext,retailerpin,productprice,retailercity,retailerstate);				     
