...
public static String insertReview(String userage,String productname,String username,String producttype,String productmaker,String usergender,String useroccupation,String manrebate,String productonsale,String reviewrating,String reviewdate,String reviewtext,String retailerpin,String price,String retailercity,String retailerstate)
{
	try
		{		
			getConnection();
...
{	
	...
	while (cursor.hasNext())
	{
		   ...
		   if(!reviews.containsKey(obj.getString("productName")))
			...
			Review review =new Review(obj.getString("productName"),obj.getString("userName"),obj.getString("userage"),obj.getString("productType"),obj.getString("productMaker"),obj.getString("usergender"),obj.getString("useroccupation"),obj.getString("manrebate"),obj.getString("productonsale"),obj.getString("reviewRating"),obj.getString("reviewDate"),obj.getString("reviewText"),obj.getString("retailerpin"),obj.getString("price"),obj.getString("retailercity"),obj.getString("retailerstate"));
